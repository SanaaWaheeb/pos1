                                            ...
                                            @if ($product['variant_id'] != 0)
                                                <tr data-id="{{$key}}" id="product-variant-id-{{ $product['variant_id'] }}">
                                                    ...
                                                    <td data-label="Total">
                                                        ...
                                                        <a href="#" class="action-item mr-2 remove-btn" style="margin-right: 15px;" data-toggle="tooltip" data-original-title="{{__('Move to trash')}}" data-confirm="{{__('Are You Sure?').' | '.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-product-cart-{{$key}}').submit();"><i class="fas fa-times"></i></a>
                                            ...
                                            @else
                                                <tr data-id="{{$key}}" id="product-id-{{ $product['product_id'] }}">
                                                    ...
                                                    <td data-label="Total">
                                                        ...
                                                        @endphp
                                                        <span class="subtotal">{{\App\Models\Utility::priceFormat($totalprice)}}</span>
                                                        <a href="#" class="remove-btn" style="margin-right: 15px;" data-toggle="tooltip" data-original-title="{{__('Move to trash')}}" data-confirm="{{__('Are You Sure?').' | '.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-product-cart-{{$key}}').submit();"><i class="fas fa-times"></i></a>
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['delete.cart_item',[$store->slug,$product['product_id'],$product['variant_id']]],'id'=>'delete-product-cart-'.$key]) !!}
                                                        {!! Form::close() !!}
                                                    </td>
                                                </tr> 

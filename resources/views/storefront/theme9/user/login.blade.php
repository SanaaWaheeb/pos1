...
@section('content')
<div class="wrapper">
    <section class="login-section padding-top" style="padding-bottom: 40px;">
        <div class="bg-image">
                ...
                <div class="col-lg-7 col-md-12 col-12">
                    <div class="login-form">
                        <h3>{{__('Customer')}} <span> {{__('login')}}</h3>
                            ...
                            {!! Form::close() !!}
                            <p class="register-btn">{{__("Don't have an account? ")}}<a href="{{route('store.usercreate',$slug)}}" class="btn">{{__('Register')}}</a></p>
                    </div>
                </div>
            </div>
        </div>

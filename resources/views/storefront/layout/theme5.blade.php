...
<body class="{{ !empty($themeClass)? $themeClass : 'theme5-v1' }}">
    ...
    <script type="text/javascript">
         ...
         function disableScroll() {
          // Step 1: Hide overflow
          document.body.style.overflow = 'hidden';
          document.documentElement.style.overflow = 'hidden';
        
          // Step 2: Prevent touch scrolling on mobile
          document.addEventListener('touchmove', preventDefault, { passive: false });
          document.addEventListener('wheel', preventDefault, { passive: false }); // for trackpads/mouse
        }
        ...
        // Example: disable scrolling right away
        disableScroll();
        
        // Example: re-enable scrolling after 5 seconds
